...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlatformParentSingle :  IEquatable<PlatformParentSingle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformParentSingle" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlatformParentSingle() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformParentSingle" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="platforms">platforms (required).</param>
        public PlatformParentSingle(string name = default(string), List<Platform> platforms = default(List<Platform>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PlatformParentSingle and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platforms == null)
            {
                throw new InvalidDataException("platforms is a required property for PlatformParentSingle and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PlatformParentSingle);
        }

        /// <summary>
        /// Returns true if PlatformParentSingle instances are equal
        /// </summary>
        /// <param name="input">Instance of PlatformParentSingle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlatformParentSingle input)
        {
            if (input == null)
                return false;
