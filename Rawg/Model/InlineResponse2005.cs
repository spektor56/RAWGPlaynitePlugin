...
namespace Rawg.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(int? count = default(int?), string next = default(string), string previous = default(string), List<GamePersonList> results = default(List<GamePersonList>))
        {
        ...
        public List<GamePersonList> Results { get; set; }
