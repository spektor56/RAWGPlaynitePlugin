...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(int? count = default(int?), string next = default(string), string previous = default(string), List<PlatformParentSingle> results = default(List<PlatformParentSingle>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
        ...
        public List<PlatformParentSingle> Results { get; set; }
