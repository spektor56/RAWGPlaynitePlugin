...
namespace Rawg.Model
{
    ...
    public partial class Developer :  IEquatable<Developer>, IValidatableObject
    {
        ...
        public Developer(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Developer and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as Developer);
        }

        /// <summary>
        /// Returns true if Developer instances are equal
        /// </summary>
        /// <param name="input">Instance of Developer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Developer input)
        {
            if (input == null)
                return false;
