...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(int? count = default(int?), string next = default(string), string previous = default(string), List<GameSingle> results = default(List<GameSingle>))
        {
        ...
        public List<GameSingle> Results { get; set; }
