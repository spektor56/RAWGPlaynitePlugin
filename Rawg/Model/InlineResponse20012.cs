...
namespace Rawg.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(int? count = default(int?), string next = default(string), string previous = default(string), List<Store> results = default(List<Store>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20012 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20012 and cannot be null");
            }
            else
            {
