...
namespace Rawg.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(int? count = default(int?), string next = default(string), string previous = default(string), List<ScreenShot> results = default(List<ScreenShot>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
                this.Count = count;
