...
namespace Rawg.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeveloperSingle :  IEquatable<DeveloperSingle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeveloperSingle" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeveloperSingle() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeveloperSingle" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="description">description.</param>
        public DeveloperSingle(string name = default(string), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DeveloperSingle and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as DeveloperSingle);
        }

        /// <summary>
        /// Returns true if DeveloperSingle instances are equal
        /// </summary>
        /// <param name="input">Instance of DeveloperSingle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeveloperSingle input)
        {
            if (input == null)
                return false;
