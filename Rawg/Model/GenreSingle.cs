...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenreSingle :  IEquatable<GenreSingle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenreSingle" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenreSingle() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenreSingle" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="description">description.</param>
        public GenreSingle(string name = default(string), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GenreSingle and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GenreSingle);
        }

        /// <summary>
        /// Returns true if GenreSingle instances are equal
        /// </summary>
        /// <param name="input">Instance of GenreSingle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenreSingle input)
        {
            if (input == null)
                return false;
