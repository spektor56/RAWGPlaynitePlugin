...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Publisher :  IEquatable<Publisher>, IValidatableObject
    {
        /// <summary>
        ...
        public Publisher(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Publisher and cannot be null");
            }
            else
            {
                this.Name = name;
