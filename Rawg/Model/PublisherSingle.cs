...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PublisherSingle :  IEquatable<PublisherSingle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublisherSingle" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublisherSingle() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublisherSingle" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="description">description.</param>
        public PublisherSingle(string name = default(string), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PublisherSingle and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as PublisherSingle);
        }

        /// <summary>
        /// Returns true if PublisherSingle instances are equal
        /// </summary>
        /// <param name="input">Instance of PublisherSingle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublisherSingle input)
        {
            if (input == null)
                return false;
