...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GamePersonList :  IEquatable<GamePersonList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GamePersonList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GamePersonList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GamePersonList" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        public GamePersonList(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GamePersonList and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GamePersonList);
        }

        /// <summary>
        /// Returns true if GamePersonList instances are equal
        /// </summary>
        /// <param name="input">Instance of GamePersonList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GamePersonList input)
        {
            if (input == null)
                return false;
